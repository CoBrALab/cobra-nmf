...
left_mask = np.loadtxt('../surfsamp/mask_files/CIVET_2.0_mask_left_short.txt') #MODIFY point to your left mask file
...
right_mask = np.loadtxt(mask_dir + "CIVET_2.0_mask_right_short.txt") #MODIFY point to your left mask file
right_valid = (np.where(right_mask==1))
right_invalid = (np.where(right_mask==0))

fname = sys.argv[1] #.mat file containing nmf results
out_dir=sys.argv[2]
